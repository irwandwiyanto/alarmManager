package dicoding.tutorial.myalarmmanager;
...
import static dicoding.tutorial.myalarmmanager.AlarmReceiver.TYPE_ONE_TIME;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOneTimeDate = (Button)findViewById(R.id.btn_one_time_alarm_data);
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.btn_one_time_alarm_data){
            final Calendar cureentDate = Calendar.getInstance();
            ...
            }, cureentDate.get(Calendar.YEAR), cureentDate.get(Calendar.MONTH), cureentDate.get(Calendar.DATE)).show();
        }
